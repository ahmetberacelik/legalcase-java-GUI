/**
 * @file ConsoleHelper.java
 * @brief Console utility class for the Legal Case Tracker system
 *
 * This file contains utility methods for standardized console input/output operations,
 * including displaying formatted messages, reading user input with validation,
